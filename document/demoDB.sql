...
INSERT INTO `client` VALUES (17,NULL,NULL,'q2381050@gmail.com','',NULL,NULL,NULL,NULL,_binary '',NULL,NULL,5,'e6fc5948-d316-4eb4-8607-01bf3475ca7f','2024-03-15 15:56:50',NULL,0,_binary '\0',NULL,NULL,'system','system','2024-03-14 15:56:50','2024-03-14 15:56:50');
...
CREATE TABLE `system_parameter_setting` (
  ...
  `system_text` text COMMENT '參數內容，當value不夠時才需要使用\n',
  `create_user` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2024-03-15  0:55:30
